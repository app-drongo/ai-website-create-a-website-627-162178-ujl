        ...
        <div className="flex h-16 items-center justify-between">
              ...
              {navigation.map((item) => (
                <Link
                  ...
                  className={cn(
                    ...
                    (!isTransparent || isScrolled) && "text-muted-foreground hover:text-accent-foreground hover:bg-accent",
                    // TRANSPARENT MODE: Light text only when transparent and not scrolled
                    isTransparent && !isScrolled && lightText && "text-white/90 hover:text-white hover:bg-white/10",
                    isTransparent && !isScrolled && !lightText && "text-muted-foreground hover:text-accent-foreground hover:bg-accent/50"
                  )}
                >
                  {item.name}
                </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Button 
              ...
              className={cn(
                isTransparent && !isScrolled && lightText && "text-white hover:text-white hover:bg-white/10"
              )}
            >
              Sign In
            </Button>
